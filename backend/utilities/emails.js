...
const emailRegistro = async (datos) =>{
    ...
    await transport.sendMail({
        ...
        <a href="${process.env.BACKEND_URL || localhost}:${process.env.PORT}/auth/login/${token}">Confirmar cuenta</a></p>
...
const emailRecuperacion = async (datos) =>{
    ...
    await transport.sendMail({
        ...
        <a href="${process.env.BACKEND_URL}:${process.env.PORT}/auth/se-me-olvido/${token}">Recuperar clave</a></p>
